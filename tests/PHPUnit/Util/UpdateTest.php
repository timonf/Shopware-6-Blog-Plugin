...
class UpdateTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $connection->expects($this->any())->method('getSchemaManager')->willReturn($this->schemaManager);

        $this->container = $this->createMock(ContainerInterface::class);
        $this->container->expects($this->any())->method('get')->willReturn($connection);
     ...
     * @param int $getCurrentPluginVersionExpectedCalls
     * @param int $tablesExistExpectedCalls
     * @return void
    ...
    public function testUpdate(
        ...
        $this->updateContext->expects($this->exactly($getCurrentPluginVersionExpectedCalls))
            ->method('getCurrentPluginVersion')
            ->willReturn($version);
        $this->schemaManager->expects($this->exactly($tablesExistExpectedCalls))
            ->method('tablesExist')
            ->with($this->callback(function ($object): bool {
